...
if __name__ == '__main__':
    audio_path = '../audio/00520210909060228.wav'
    ...
    print(feature.shape)
    audio = frequency_mask_augment(audio, max_mask_frequency=5, mask_num=10)
    soundfile.write("../audio/00520210909060228_test.wav",audio,samplerate=sampling_rate)
